...
def main():
    ...
    color = st.color_picker("Pilih warna untuk background:", "#808080")
...
# Tambahkan elemen dengan kelas "bounce" untuk menerapkan animasi bounce
    ...
    st.markdown('<hr style="border: none; height: 5px; background: linear-gradient(to right, red, orange, yellow, green, blue, indigo, violet);"/>',
                unsafe_allow_html=True)
    image_path = 'dimas.jpeg''rayyan.jpeg'# Ganti dengan path yang sesuai ke file gambar Anda
    st.image(image_path, caption='Dimas Farrel Arunajati (2320511)'' Fadhlurahman Rayyandani Shafwan (2320522)')
